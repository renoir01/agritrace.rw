...
class SMSService {
  ...
  Future<bool> sendOrderAcceptedNotification({
    ...
    final message = '$farmerName accepted your order for ${quantity.round()}kg. '
  ...
  Future<bool> sendOrderRejectedNotification({
    ...
    final message = '$farmerName declined your order for ${quantity.round()}kg. '
        'Try another farmer on iTraceLink app.';
    return await sendSMS(phoneNumber: phoneNumber, message: message);
  }
  ...
  Future<bool> sendHarvestReminder({
    ...
    final message = 'Reminder: Expected harvest date for $farmerName is $expectedDate. '
